...
namespace Plugin.CrmServices.XrmSdk
{
    ...
    public partial class Account : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public System.Nullable<Plugin.CrmServices.XrmSdk.AccountState> StateCode
        {
            get
            {
                ...
                if ((optionSet != null))
                {
                    return ((Plugin.CrmServices.XrmSdk.AccountState)(System.Enum.ToObject(typeof(Plugin.CrmServices.XrmSdk.AccountState), optionSet.Value)));
                }
                else
                {
                    return null;
    ...
    public partial class ServiceContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
    {
        ...
        /// <summary>
        /// Gets a binding to the set of all <see cref="Plugin.CrmServices.XrmSdk.Account"/> entities.
        /// </summary>
        public System.Linq.IQueryable<Plugin.CrmServices.XrmSdk.Account> AccountSet
        {
            get
            {
                return this.CreateQuery<Plugin.CrmServices.XrmSdk.Account>();
            }
        }
    }
}
